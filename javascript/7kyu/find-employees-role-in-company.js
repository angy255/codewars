...
function findEmployeesRole(fullName) {
  ...
  for (let i = 0; i < employees.length; i++) {
    ...
    // check if both firstName and lastName match
    if (employee.firstName === firstName && employee.lastName === lastName) {
      return employee.role; // return the role if found
    }
  }

  // if no match found, return this message
